...
using AwesomeMaps.Droid;

[assembly: Xamarin.Forms.ExportRenderer(typeof(CameraPageClass), typeof(CameraPageClassRenderer))]
namespace AwesomeMaps.Droid
{
    public class CameraPageClassRenderer : PageRenderer, TextureView.ISurfaceTextureListener
    {
        ...
        public void SetupEventHandlers()
        {
            capturePhotoButton.Click += async (sender, e) =>
            {
                ...
                (Element as CameraPageClass).SetPhotoResult(bytes, liveView.Bitmap.Width, liveView.Bitmap.Height);
            };
        ...
        public override bool OnKeyDown(Keycode keyCode, KeyEvent e)
        {
            ...
            {
                (Element as CameraPageClass).Cancel();
                return false;
            }
